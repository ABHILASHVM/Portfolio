  ...
  return (
    <div className={darkMode ? "dark" : ""}>
      <Head>
        ...
        <script src="https://mediafiles.botpress.cloud/cbcc0236-c5ab-4c14-9bc0-1d8d239ceb72/webchat/config.js" async></script>
      ...
      <main className=" bg-white px-10 dark:bg-gray-900 md:px-20 lg:px-40">
        <section className="min-h-screen">
          <nav className="pt-10 pb-5 lg:pb-10 md:pb-10 mb-11 flex justify-between dark:text-white">
